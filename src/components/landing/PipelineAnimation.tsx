...
export function PipelineAnimation() {
  ...
  return (
    <div ref={sectionRef} aria-hidden className="relative w-full max-w-3xl mx-auto min-h-[380px] flex items-center justify-center">
      <AnimatePresence mode="wait">
        {phase !== "result" ? (
          /* ── 1·2단계: 대화 수집 + AI 처리 ─────────────── */
          <motion.div
            key="chat"
            className="relative w-full flex flex-col gap-4 max-w-lg mx-auto"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
